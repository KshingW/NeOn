...
class XFeat(nn.Module):
	...
	def __init__(self, device, top_k = 4096, detection_threshold=0.05):
		super().__init__()
		self.dev = device
		self.top_k = top_k
	...
	def refine_matches(self, d0, d1, matches, batch_idx, fine_conf = 0.25):
		...
		# print("refine_matches feats", feats1.shape, feats2.shape, feats1.mean(), feats2.mean())
		# print("refine_matches mkpts", mkpts_0.shape, mkpts_1.shape, mkpts_0.mean(), mkpts_1.mean())
